...
export class User extends Base {
    ...
    constructor(json: object) {
        ...
        if (json) {
            ...
            this.firstName = json['c1_001'];
            this.lastName = json['c1_002'];
            ...
            console.info('TODO: En el bloque perfil añadir cuerpo de profesorado y especialidades');
            let positions = new Array<Position>();
            positions.push(new Position('11597038', 'Educación Primaria - Bilingüe Inglés'));
            positions.push(new Position('00597038', 'Educación Primaria'));
